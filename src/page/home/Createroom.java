...
public class Createroom extends JFrame {
    ...
    public Createroom(Server server, ClientObj clientObj, GameCenter gameCenter) {
        ...
        start.addActionListener(e -> {
            try {
                ...
                SwingUtilities.invokeLater(() -> {
                    ...
                    new WindowClosingFrameEvent()
                            .navigateTo(
                                    Createroom.this,
                                    new WaitingRoom(server, clientObj, gameCenter, numofplayer),
                                    false);
                });
