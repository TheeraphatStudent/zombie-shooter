...
public class Sumstat extends JPanel {
    ...
    public Sumstat(
        ...
        statContain.add(
                new UseText(20, 200, 30, false).createSimpleText("Name: " + client.getClientName(), Color.BLACK, Color.WHITE,
                        Font.PLAIN),
                statGridConst);
        statGridConst.gridy = 1;
        statContain.add(
                new UseText(20, 200, 30, false).createSimpleText("IP: " + client.getClientIp(), Color.BLACK, Color.WHITE,
                        Font.PLAIN),
                statGridConst);
        statGridConst.gridy = 2;
        statContain.add(
                new UseText(20, 200, 30, false).createSimpleText("Kill: " + player.getZombieHunt(), Color.BLACK,
                        Color.WHITE, Font.PLAIN),
                statGridConst);
        statGridConst.gridy = 3;
        statContain.add(
                new UseText(20, 200, 30, false).createSimpleText("Rank: " + player.getRank(), Color.BLACK, Color.WHITE,
                        Font.PLAIN),
                statGridConst);
        statGridConst.gridy = 4;
        statContain.add(
                new UseText(20, 200, 30, false).createSimpleText("Alive Time: " + player.getAliveTime(), Color.BLACK,
                        Color.WHITE, Font.PLAIN),
                statGridConst);
